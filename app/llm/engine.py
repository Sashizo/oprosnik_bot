...
_ACK_SYSTEM_PROMPT = (
    ...
    "Тебе доступна история предыдущих вопросов и ответов участника. "
    "Твоя задача: написать ровно 1–2 нейтральных предложения-подтверждения "
    "текущего ответа участника. "
    "При необходимости можешь мягко отразить осведомлённость о ранее сказанном — "
    "без прямого цитирования и без оценочных суждений. "
    ...
    "Пример с контекстом (тоже правильно): "
    "«Это согласуется с тем, о чём вы говорили в начале.»\n"
